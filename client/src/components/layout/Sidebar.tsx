...
export default function Sidebar({ 
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(126,87,194,0.1)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="mt-auto border-t border-white/5 p-4 flex flex-col items-center gap-3">
        <button
          onClick={() => onViewChange('settings')}
          className="flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-600/10 border border-purple-500/20 hover:bg-purple-600 hover:border-purple-500 transition-all group shadow-lg shadow-purple-900/20 active:scale-90"
          title="Configurações"
        >
        ...
        <button
          onClick={onSignOut}
          className="flex h-12 w-12 items-center justify-center rounded-2xl text-slate-500 hover:text-red-400 hover:bg-red-500/10 transition-all active:scale-90 border border-transparent hover:border-red-500/20"
          title="Sair"
        >
          <Power size={20} />
        </button>
