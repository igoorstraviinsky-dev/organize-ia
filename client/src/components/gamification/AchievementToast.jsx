  ...
  return (
    <AnimatePresence>
      {toast && (
        ...
        >
          <div className={`bg-[#17112E]/90 backdrop-blur-xl border ${toast.type === 'penalty' ? 'border-red-500/30' : 'border-yellow-500/30'} rounded-3xl p-1 shadow-2xl overflow-hidden`}>
            ...
            <div className="relative flex items-center gap-4 p-4">
              <div className={`flex h-12 w-12 items-center justify-center rounded-2xl ${toast.type === 'penalty' ? 'bg-red-500' : 'bg-yellow-500'} shadow-lg ${toast.type === 'penalty' ? 'shadow-red-500/20' : 'shadow-yellow-500/20'}`}>
              ...
              {toast.xp && (
                <div className="flex flex-col items-center justify-center px-4 border-l border-white/10">
                  <span className={`text-lg font-black ${toast.type === 'penalty' ? 'text-red-500' : 'text-yellow-500'}`}>
