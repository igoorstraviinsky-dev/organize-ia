...
3. Atribuição Direta: Para atribuições na criação, use SEMPRE o parâmetro assigned_user_identifier dentro da função de criação correspondente. Não chame assign_task ou assign_project_member separadamente se estiver criando o item agora.
